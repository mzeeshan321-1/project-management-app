                ...
                <div class="col-md-6">
                    <div class="form-floating">
                        <input type="text" name="specialization" class="form-control"
                            value="{{ $expert->specialization }}" placeholder="Specialization" id="Specialization" required>
                ...
                <div class="col-md-6">
                    <div class="form-floating">
                        <select class="form-select" name="status" id="Status" aria-label="Status"
                            ...
                            <option selected value="active" {{ $expert->user->status == 'active' ? 'selected' : '' }}>
                                Active
                            </option>
                            <option value="inactive" {{ $expert->user->status == 'inactive' ? 'selected' : '' }}>Inactive
                            </option>
                            <option value="suspended" {{ $expert->user->status == 'suspended' ? 'selected' : '' }}>
                                Suspended
                            </option>
                        </select>
                            ...
                            @if (!empty($expert->user->image))
                                <div class="d-flex justify-content-center mt-3">
                                    <img src="{{ asset('images/' . $expert->user->image) }}"
                                        alt="{{ $expert->user->name }}" class="img-thumbnail" id="preview">
                                </div>
