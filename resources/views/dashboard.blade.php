        ...
        <div class="row gy-4">
            ...
            <div class="col-12">
                <div class="row gy-4">
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                <div class="card-icon rounded-circle d-flex align-items-center justify-content-center"
                                                                    style="background-color: #e0f8e9;">
                                                                    <i class="bi bi-person-badge" style="color: #2eca6a;"></i>
                                                                </div>
                                                                <div class="ps-3">
                                                                    <h6>{{ $expertsCount }}</h6>
                                                                    <span class="text-muted small pt-2 ps-1">Manage Experts <i
                                                    ...
                                                    <div class="card info-card revenue-card">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="ps-3">
                                                                    <h6>{{ $clientsCount }}</h6>
                                                                    <span class="text-muted small pt-2 ps-1">Manage Clients <i
                                                                            class="bi bi-arrow-right"></i></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="card info-card revenue-card">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="ps-3">
                                                                    <h6>{{ $tanentsCount }}</h6>
                                                                    <span class="text-muted small pt-2 ps-1">Manage Tenants <i
                                                                            class="bi bi-arrow-right"></i></span>
                                                                </div>
                                                            </div>
                                                        </div>
                    ...
                    @canany(['manage projects', 'view projects', 'request new projects', 'update project status', 'assign
                        projects'])
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row gy-4">
                                        <!-- Projects Card -->
                                        @canany(['manage projects', 'view projects', 'request new projects', 'update project
                                            status'])
                                            <div class="col-xxl-3 col-md-4">
                                                    ...
                                                    <div class="card info-card projects-card">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="ps-3">
                                                                    <h6>{{ $projectsCount }}</h6>
                                                                    <span class="text-muted small pt-2 ps-1">Manage Projects <i
                                                                            class="bi bi-arrow-right"></i></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <a class="icon" href="{{ route('project_assignments.index') }}">
                                                    <div class="card info-card assignments-card">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                <div class="card-icon rounded-circle d-flex align-items-center justify-content-center"
                                                                    style="background-color: #e0f8ff;">
                                                                    <i class="bi bi-diagram-3" style="color: #00a0e0;"></i>
                                                                </div>
                                                                <div class="ps-3">
                                                                    <h6>{{ $projectAssignmentsCount }}</h6>
                                                                    <span class="text-muted small pt-2 ps-1">Project Assignments <i
                                                                            class="bi bi-arrow-right"></i></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="card info-card tasks-card">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="ps-3">
                                                                    <h6>{{ $tasksCount }}</h6>
                                                                    <span class="text-muted small pt-2 ps-1">Manage Tasks <i
                                                                            class="bi bi-arrow-right"></i></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <a class="icon" href="{{ route('payments.index') }}">
                                                    <div class="card info-card payments-card">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                <div class="card-icon rounded-circle d-flex align-items-center justify-content-center"
                                                                    style="background-color: #e0fff4;">
                                                                    <i class="bi bi-cash-stack" style="color: #00c853;"></i>
                                                                </div>
                                                                <div class="ps-3">
                                                                    <h6>{{ $paymentsCount }}</h6>
                                                                    <span class="text-muted small pt-2 ps-1">Manage Payments <i
                                                                            class="bi bi-arrow-right"></i></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="card info-card reports-card">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="ps-3">
                                                                    <h6>{{ $profitsCount }}</h6>
                                                                    <span class="text-muted small pt-2 ps-1">View Reports <i
                                                                            class="bi bi-arrow-right"></i></span>
                                                                </div>
                                                            </div>
                                                        </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row gy-4">
                                        <!-- Files Card -->
                                        @canany(['upload project deliverables', 'manage project deliverables', 'update project
                                            dileverables'])
                                            <div class="col-xxl-3 col-md-4">
                                                    ...
                                                    <div class="card info-card files-card">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="ps-3">
                                                                    <h6>{{ $filesCount }}</h6>
                                                                    <span class="text-muted small pt-2 ps-1">Manage Files <i
                                                                            class="bi bi-arrow-right"></i></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="activity-item d-flex">
                                                    ...
                                                    <div class="activity-content">
                                                        <a href="{{ route('projects.show', $project) }}"
                                                            class="fw-bold text-dark">{{ $project->title }}</a>
                                                        <br>
                                                        <small
                                            ...
                                            @forelse($pendingTasks as $task)
                                                <div class="activity-item d-flex">
                                                    <div class="activite-label">
                                                        {{ $task->due_date ? \Carbon\Carbon::parse($task->due_date)->diffForHumans() : 'No deadline' }}
                                                    </div>
                                                    <i class='bi bi-circle-fill activity-badge text-warning align-self-start'></i>
                                                    <div class="activity-content">
                                                        <a href="{{ route('tasks.show', $task) }}"
                                                            class="fw-bold text-dark">{{ $task->title }}</a>
                                                        <br>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="activity">
                                            @forelse($recentPayments as $payment)
                                                <div class="activity-item d-flex">
                                                    <div class="activite-label">
                                                        {{ $payment->created_at ? $payment->created_at->diffForHumans() : 'N/A' }}
                                                    </div>
                                                    <i class='bi bi-circle-fill activity-badge text-info align-self-start'></i>
                                                    <div class="activity-content">
                                                        Payment for <a href="#"
                                                            class="fw-bold text-dark">{{ $payment->project->title ?? 'Project' }}</a>
                                                        <br>
